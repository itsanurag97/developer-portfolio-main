      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          <h1 className="text-3xl font-bold leading-10 text-white md:font-extrabold lg:text-[2.6rem] lg:leading-[3.5rem]">
            ...
            .{` I have taken traning as a `}
            <span className=" text-[#16f2b3]">{personalData.traning}</span>
            {` from Naresh i Technologies Ameerpet, Hyderabad Telangana.`}
          </h1>
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Anurag Kumar</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Java SE</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Jakarta EE</span>
                <span className="text-gray-400">{"', '"}</span>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-amber-300">Notpad</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Edit Plus</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Vs Code</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">Eclipse</span>
                <span className="text-gray-400">{"', '"}</span>
                <span className="text-amber-300">NetBeans</span>
                <span className="text-gray-400">{"', '"}</span>
